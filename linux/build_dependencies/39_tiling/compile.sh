#!/bin/bash
  ...
  # file locations
  LIB="-L./ -L./lib -L~/lib -L/lib -L/usr/lib -L/usr/local/lib -L/usr/lib/arm-linux-gnueabihf -lSDL2_image"
  ...
  # compile program
  g++ `sdl2-config --cflags --libs` $LIB $GLIB $INC $GINC -v -o sdl2_test 39_tiling.cpp  #>> compile.log 2>&1
