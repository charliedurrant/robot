  ...
  public class ProjectInfo_CPP : ProjectInfo
  {
    ...
    public string PrecompiledHeader
    {
      get
      {
        ...
        s = MakeItSoConfig.Instance.getProjectConfig(this.Name).PrecompiledHeader;
        return s;
      }
    }

    public string PrecompiledHeaderFileNameMatch
    {
      get
      {
        string s;

        s = this.PrecompiledHeader;
        if (!string.IsNullOrEmpty(s))
        {
          s = Path.ChangeExtension(s, ".cpp");
        }
        return s;
      }
    }

    public string PrecompiledHeaderBuiltName
    {
      get
      {
        string s;
        ...
        if (!string.IsNullOrEmpty(s))
        {
          s = Path.ChangeExtension(s, ".h.gch");
        }
        return s;
      }
    }
