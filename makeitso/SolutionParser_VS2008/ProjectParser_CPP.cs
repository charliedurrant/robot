...
namespace SolutionParser_VS2008
{
    ...
    internal class ProjectParser_CPP
    {
        ...
        private void parseProject()
        {
            ...
            // Note: We parse the configurations before the source files
            //       as files may include custom build rules (which can be
            //       different in each configuration). So we need to know 
            //       about the configurations first.
